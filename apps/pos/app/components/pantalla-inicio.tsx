 ...
 *
 * Comportamiento por modo (decidido con el dueño):
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <div className="mt-px text-xs text-ink-3">
              {caja.nombre} · <span className="text-success">Turno {turno.codigo_turno}</span>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
            <BotonOperacion
              ...
              sub={ventaTurno === null ? "Cargando…" : `${fmtMxn(ventaTurno)} en el turno`}
            ...
            <BotonOperacion
              ...
              sub={nEnEspera > 0 ? `${nEnEspera} en espera` : "Historial del turno"}
...
function BotonOperacion({
  label, sub, icon, onClick, peligro,
}: { label: string; sub: string; icon: ReactNode; onClick: () => void; peligro?: boolean }) {
  return (
    <button
      type="button"
      onClick={onClick}
