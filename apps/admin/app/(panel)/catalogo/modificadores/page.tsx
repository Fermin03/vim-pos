                  ...
                  <tr key={g.id} className="group cursor-pointer border-b border-line last:border-none hover:bg-hover" onClick={() => router.push(`/catalogo/modificadores/${g.id}`)}>
                    ...
                    <td className="px-4 py-3.5 text-right" onClick={(e) => e.stopPropagation()}>
                      <span className="inline-flex gap-1 transition-opacity lg:opacity-0 lg:group-hover:opacity-100">
                        <button type="button" title="Editar" onClick={() => router.push(`/catalogo/modificadores/${g.id}`)} className="flex h-10 w-10 items-center justify-center rounded border border-transparent lg:h-8 lg:w-8 text-ink-3 transition hover:border-line-strong hover:bg-surface hover:text-ink">
                        ...
                        <button type="button" title="Eliminar" onClick={() => setBorrar(g)} className="flex h-10 w-10 items-center justify-center rounded border border-transparent lg:h-8 lg:w-8 text-ink-3 transition hover:border-[#E8C5C0] hover:text-danger">
