...
1. **Menú completo de Knock-Out** ⏳ EN PROCESO — el dueño enviará foto del menú actual, Claude transcribe a tabla estructurada.
...
7. **Observación etnográfica** ⏳ EN PROCESO — Trabajo combinado:
   ...
   - **el dueño:** 1-2 turnos completos en Knock-Out con libreta física (próximas 1-2 semanas)
   - Integración final cuando ambos estén completos

---

*Documento de flujos del módulo Quick Service — VIM POS v3.2. Plan Maestro — el dueño, VIM Marketing.*
