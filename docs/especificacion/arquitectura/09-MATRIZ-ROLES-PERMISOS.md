...
- **el dueño** lo lee de principio a fin la primera vez, después usa §4 (matriz) y §5 (PINs) como referencia rápida.
...
| **D73** | El SUPER_ADMIN solo existe a nivel de plataforma (el dueño + equipo VIM Marketing), nunca asignable por tenant | §3.1 — separación clara |
...
|---|---|---|---|---|
| 1 | `SUPER_ADMIN` | 9 | Plataforma | el dueño + equipo VIM Marketing (D73) |
...
Cuando se crea un tenant nuevo (el dueño lo crea para Knock-Out Burger), automáticamente:
