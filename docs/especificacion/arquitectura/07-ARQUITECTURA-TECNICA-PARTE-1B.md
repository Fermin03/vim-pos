...
Cuando el dueño entregue la foto del menú, se transcribirá a este formato. Por ahora, una hamburguesa de ejemplo para validar el schema.
...
> **Cuando el dueño decida activar inventario:** los seeds de insumos y recetas se generarán a partir de la foto del menú + observación etnográfica. El schema ya está listo.
