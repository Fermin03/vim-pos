...
- Una persona mantiene el código (el dueño + Claude Code). Multi-schema multiplica migraciones por N tenants.
...
- §0 Introducción + 13 decisiones de diseño confirmadas con el dueño
