...
Para que VIM Marketing (el dueño) vea ventas agregadas de todos los clientes piloto y tome decisiones de producto. Requiere romper RLS controladamente vía service_role + funciones específicas. Fase 2 con dashboard de SaaS owner.
...
- ❌ Dashboard consolidado multi-tenant para el dueño como SaaS owner (Fase 2)
