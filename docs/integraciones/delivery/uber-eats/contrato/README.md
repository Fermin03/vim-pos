...
- Provider: **VIM POS**, persona física (Founder & CEO), con RFC; contacto
  `integraciones@vimpos.com.mx`. Es decir, hoy el contrato obliga a el dueño a título personal, no a
...
| C13 | Certificado anual de cumplimiento a petición de Uber (firmado por un directivo); negarlo es incumplimiento material | 3.2.2, TOU III.B | ✅ | Respaldo documental listo: `datos-e-incidentes-delivery.md` completo; el dueño firma cuando Uber lo pida |
...
1. Guardar la copia **firmada** del contrato aquí y confirmar las casillas de APIs (el dueño).
