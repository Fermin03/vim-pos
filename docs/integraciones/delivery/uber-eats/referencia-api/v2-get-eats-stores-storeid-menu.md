<!-- fuente: https://developer.uber.com/docs/eats/references/api/v2/get-eats-stores-storeid-menu -->
## Get Menu

`GEThttps://api.uber.com/v2/eats/stores/{store_id}/menus`
...
This _Get Menu_ endpoint allows a developer pull the entire menu for a specific store. Note, this response may be very large.
...
| Name | Type | Description |
| --- | --- | --- |
| `menus` | [Menu](#response-body-parameters-menu)\[\] | List of the store’s menus. |
| `categories` | [Category](#response-body-parameters-category)\[\] | List of the store’s menu categories. |
| `items` | [Item](#response-body-parameters-item)\[\] | List of the store’s items. |
| `modifier_groups` | [ModifierGroup](#response-body-parameters-modifiergroup)\[\] | List of the store’s modifier groups. |
...
| `title` | [MultiLanguageText](#response-body-parameters-multilanguagetext) | The name of the menu to be displayed (by locale). |
| `subtitle` | [MultiLanguageText](#response-body-parameters-multilanguagetext) | An optional subtitle for the menu (by locale). |
| `service_availablity` | [ServiceAvailability](#response-body-parameters-service-availability)\[\] | The days and times of the day at which this menu should be made available. |
...
Locale codes should specify both language and country codes, e.g. “en\_us” |
...
-   `“sunday”`
 ...
 |
| `time_periods` | [TimePeriod](#response-body-parameters-timeperiod)\[\] | The continuous time spans during which the menu is available. |
...
| `title` | [MultiLanguageText](#response-body-parameters-multilanguagetext) | The displayed name for the category (by locale). |
| `subtitle` | [MultiLanguageText](#response-body-parameters-multilanguagetext) | (_optional_) A subtitle for the category (by locale). |
| `entities` | [MenuEntity](#response-body-parameters-menuentity)\[\] | The top-level menu items available for sale within the category - all entities must be of type `“ITEM”`. |
...
| `external_data` | string | (_optional_) Free-form text field reserved for the restaurant’s use, e.g. for POS integrations. |
| `title` | [MultiLanguageText](#response-body-parameters-multilanguagetext) | The name of the item (by locale). |
| `description` | [MultiLanguageText](#response-body-parameters-multilanguagetext) | (_optional_) Supplementary information describing the item (by locale). |
...
-   320px ≤ Height ≤ 6000px
 ...
 |
| `price_info` | [PriceRules](#response-body-parameters-pricerules) | Specifies the price to charge for ordering the item. Allows overrides dependent on the ordered item’s context.  
...
| `quantity_info` | [QuantityConstraintRules](#response-body-parameters-quantityconstraintrules) | (_optional_) Constrains the quantities in which the item can be ordered. Only applies to items used within a modifier group. Allows overrides dependent on the ordered item’s context. |
| `suspension_info` | [SuspensionRules](#response-body-parameters-suspensionrules) | (_optional_) Suspends the item from sale, e.g. when out of stock, until a specified time. Allows overrides dependent on context. |
| `modifier_group_ids` | [ModifierGroupsRules](#response-body-parameters-modifiergroupsrules) | (_optional_) Specifies the modifier groups to be associated with the item, allowing the user to make choices or bundle extras with their purchase. Allows overrides dependent on context. |
| `tax_info` | [TaxInfo](#response-body-parameters-taxinfo) | Specifies the taxes applicable to the item. |
...
| `selling_info` | [SellingInfo](#response-body-parameters-sellinginfo) | (_optional_) Defines the selling information for an item |
...
| `overrides` | [PriceOverride](#response-body-parameters-priceoverride)\[\] | (_optional_) Overrides for the price in different contexts. |
| `priced_by_unit` | [MeasurementUnit](#response-body-parameters-measurementunit) | (_optional_) “per measurement” unit the item price is based on. |
...
| Name | Type | Description |
| --- | --- | --- |
| `quantity` | [QuantityConstraint](#response-body-parameters-quantityconstraint) | Default quantity constraints for the item. |
| `overrides` | [QuantityConstraintOverride](#response-body-parameters-quantityconstraintoverride)\[\] | (_optional_) Overrides for the quantity constraints in different contexts. |
...
-   `“MODIFIER_GROUP”`
 ...
 |
| `context_value` | string | Identifying string (id) for the specified context. |
| `quantity` | [QuantityConstraint](#response-body-parameters-quantityconstraint) | Quantity constraints for the item in this context. |
...
| Name | Type | Description |
| --- | --- | --- |
| `suspension` | [Suspension](#response-body-parameters-suspension) | (_optional_) Any active suspension for the item. |
| `overrides` | [SupensionOverride](#response-body-parameters-suspensionoverride)\[\] | (_optional_) Overrides for the suspension in different contexts. |
...
-   `“MODIFIER_GROUP”`
 ...
 |
| `context_value` | string | Identifying string (id) for the specified context. |
| `suspension` | [Suspension](#response-body-parameters-suspension) | Suspension settings for the item in the context. |
...
| overrides | [ModifierGroupsOverride](#response-body-parameters-modifiergroupsoverride)\[\] | (_optional_) Overrides for the list of modifier groups in different contexts. |
...
| `is_vegetarian` | boolean | (_optional_) Not used anymore. Please use [DietaryLabelInfo](#response-body-parameters-dietarylabelinfo) instead. |
...
| `dietary_label_info` | [DietaryLabelInfo](#response-body-parameters-dietarylabelinfo) | (_optional_) Contains dietary labels. |
...
| Name | Type | Description |
| --- | --- | --- |
| `labels` | string\[\] ([DietaryLabels](#response-body-parameters-dietarylabels)) | (_optional_) A list of strings from the allowed [DietaryLabels](#response-body-parameters-dietarylabels) table below which are applicable for the item/modifier option. |
...
| Name | Type | Description |
| --- | --- | --- |
| `hours` | [VisibilityHours](#response-body-parameters-visibilityhours) | (_required_) List of time periods when an item should be visible to the eater |
...
| `hours_of_week` | [HoursOfWeek](#response-body-parameters-hoursofweek) | (_required_) List of time of day and day of week when an item should be visible when it is between the start date and end date. At least one entry is required. |
...
| `external_data` | string | (_optional_) Free-form text field reserved for the restaurant’s use, e.g. for POS integrations. |
| `title` | [MultiLanguageText](#response-body-parameters-multilanguagetext) | The displayed name of the modifier group (by locale). |
| `quantity_info` | [QuantityConstraintRules](#response-body-parameters-quantityconstraintrules) | (_optional_) Constrains the quantities in which all items within the modifier group can be ordered. Allows overrides dependent on the ordered item’s context. |
| `modifier_options` | [MenuEntity](#response-body-parameters-menuentity)\[\] | A list of menu entity objects representing available item options for the modifier group - all entities must be of type `“ITEM”`. |
...
| Name | Type | Description |
| --- | --- | --- |
| `selling_options` | [SellingOption](#response-body-parameters-sellingoption)\[\] | List containing information about how an item can be sold by. |
...
| Name | Type | Description |
| --- | --- | --- |
| `sold_by_unit` | [MeasurementUnit](#response-body-parameters-measurementunit) | (_optional_) Describes the measurement unit an item can be sold by. |
| `quantity_constraints` | [SellingQuantityConstraint](#response-body-parameters-sellingquantityconstraint) | (_optional_) Describes the constraints that an item has in a particular SellingOption. |
| `priced_by_to_sold_by_unit_conversion_info` | [PricedByToSoldByUnitConversionInfo](#response-body-parameters-pricedbytosoldbyunitconversioninfo) | (_optional_) Describes conversion info between “priced\_by” and “sold\_by” quantities. |
...
A variety of example menu payloads are provided here: [Example Menu Payloads](/docs/eats/references/api/v2/example-menu-payloads)
