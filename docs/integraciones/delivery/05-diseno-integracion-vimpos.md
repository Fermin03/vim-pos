...
**Estado:** propuesta de diseño (1 sep 2026), pendiente de validar con el dueño antes de escribir el
...
|---|---|---|
| F0 — Trámites | Solicitar acceso en las tres apps (doc 06). Registrar dominio/URL de webhooks estable | el dueño |
