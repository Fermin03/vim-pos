...
| Campo | Valor |
|---|---|
| Company name | VIM POS (VIM POS) |
| Country / City | Mexico · León, Guanajuato |
| Company type | POS / ERP integrator (SaaS) |
| Tax ID | RFC XAXX010101000 (persona física con actividad empresarial; no hay DUNS) |
| Website | https://vimpos.com.mx |
| Contact | VIM POS · integraciones@vimpos.com.mx · hola@vimpos.com.mx |
...
I am VIM POS, founder of VIM POS, a point-of-sale system for restaurants in Mexico (https://vimpos.com.mx). We have just submitted our company profile (Qualification) on the Developer Portal under integraciones@vimpos.com.mx.
...
1. NDA / Technology Integration Agreement for signature (I am the legal representative; VIM POS is a sole proprietorship, RFC XAXX010101000).
...
Thank you,
VIM POS
VIM POS · integraciones@vimpos.com.mx · hola@vimpos.com.mx · https://vimpos.com.mx
```
...
¿Nos puedes poner en contacto con el equipo de integraciones / el TAM que atiende integradores de POS en México? El contacto técnico de VIM POS es VIM POS, integraciones@vimpos.com.mx, hola@vimpos.com.mx. Lo que necesitan de Rappi es que les creen la integración y las credenciales del ambiente de pruebas.
