...
| Activación en producción | Con la cuenta | Hay que pedirla por separado (guía `multiemisor--proceso`); el dueño confirmó que **está incluida en el plan contratado** |
