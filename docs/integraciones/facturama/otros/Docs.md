<!-- fuente: https://apisandbox.facturama.mx/Docs · capturado 2026-09-03 -->
...
## 3.- Carga tus catálogos
                    ...
                    Los elementos requeridos para crear una factura cfdi:

- [Producto](https://apisandbox.facturama.mx/Docs/Api/POST-api-Product)

- [Cliente](https://apisandbox.facturama.mx/Docs/Api/POST-api-Client)

- [Sucursal](https://apisandbox.facturama.mx/Docs/Api/POST-api-BranchOffice)

## 4.- Crea tu primer cfdi

- [Emitir un CFDI](https://apisandbox.facturama.mx/docs/api/POST-2-cfdis)

## 5.- Descargar el Xml ó el PDF

                    **format**:define el formato del cfdi puede ser "pdf", "html" ó "xml"

                    **type**: tipo de xml api: "issued", "received", para api-lite: "issuedLite"
...
- [Descargar XML](https://apisandbox.facturama.mx/Docs/Api/GET-api-Cfdi-format-type-id)
                    ...
                    Ejemplo:
                        ...
                        https://api.facturama.mx/Cfdi/xml/issued/qQfgX3B_t5pUKTBFN3_DTww
