<!-- fuente: https://apisandbox.facturama.mx/docs/api/DELETE-Product-id · capturado 2026-09-03 -->
...
Identificador unico del producto que se desea eliminar.
...
Regresa un status 200 si la eliminación fue exitosa.
