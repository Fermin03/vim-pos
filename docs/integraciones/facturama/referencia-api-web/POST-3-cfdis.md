<!-- fuente: https://apisandbox.facturama.mx/docs/api/POST-3-cfdis · capturado 2026-09-03 -->
...
Fecha: Atributo requerido para la expresión de la fecha y hora de expedición del
            Comprobante Fiscal Digital por Internet.Se expresa en la forma AAAAMM-DDThh:mm:ss y debe corresponder con la hora local donde se
...
Serie: Atributo opcional para precisar la serie para control interno del
            contribuyente.Este atributo acepta una cadena de caracteres.

**
**

  Matching regular expression pattern: [^|]{1,25}
...
TipoCambio: Atributo condicional para representar el tipo de cambio FIX conforme con
...
Moneda: Atributo requerido para identificar la clave de la moneda utilizada para
...
Confirmacion: Atributo condicional para registrar la clave de confirmación que entregue
...
**
  ...
  Matching regular expression pattern: [a-zA-Z0-9]{5}
...
LugarExpedicion:Atributo requerido para incorporar el código postal del lugar de
...
Exportacion: Atributo requerido para expresar si el comprobante ampara una
...
CondicionesDePago: Atributo condicional para expresar las condiciones comerciales aplicables
...
Folio: Atributo opcional para control interno del contribuyente que expresa el
...
TipoDeComprobante: Atributo requerido para expresar la clave del efecto del comprobante
...
FormaPago: Atributo condicional para expresar la clave de la forma de pago de los
...
MetodoPago: Atributo condicional para precisar la clave del método de pago que aplica
  ...
  "Complemento": {
    ...
    "Payroll": {
      ...
      "Employee": {
        ...
        "StartDateLaborRelations": "2026-09-03T12:11:23.1900524-06:00",
      ...
      "Type": "sample string 1",
      "PaymentDate": "2026-09-03T12:11:23.2150873-06:00",
      "InitialPaymentDate": "2026-09-03T12:11:23.2150873-06:00",
      "FinalPaymentDate": "2026-09-03T12:11:23.2150873-06:00",
      "DaysPaid": 4.0
    },
    "TaxLegends": {
      "Legends": [
      ...
      "Conceptos": [
        {
          ...
          "Fecha": "2026-09-03T12:11:23.2393341-06:00",
          "Rfc": "sample string 3",
