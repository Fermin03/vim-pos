...
Hoy (3 sep 2026) no hay contrato de producción con Facturama; el dueño está en espera de contratarlo.
...
- [ ] Cuenta de **producción** en `https://app.facturama.mx` (la de sandbox no sirve; son cuentas
      distintas). RFC de la cuenta: el de VIM (el dueño, persona física).
- [ ] Confirmar por escrito que la modalidad **Multiemisor** está activa en la cuenta (el dueño ya
...
## 2. Secrets en Supabase (el dueño, dashboard → Edge Functions → Secrets)
