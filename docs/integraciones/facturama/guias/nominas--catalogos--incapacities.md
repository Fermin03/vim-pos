<!-- fuente: https://apisandbox.facturama.mx/guias/nominas/catalogos/incapacities · capturado 2026-09-03 -->
...
**https://apisandbox.facturama.mx/catalogs/incapacities**
...
```
payment_method = facturama.catalog.incapacities
```
...
```
$lstNameIds = $facturama->get('catalogs/Incapacities');
```
...
```
Facturama.Catalogs.Incapacities(function (result) {
...
```
List paymentForm = facturama.Catalogs().Incapacities();
```
...
```
var paymentForm = facturama.Catalogs.Incapacities;
```
...
self.client._credentials = ('username', 'password')
    lst_payment_methods = self.client.Incapacities.query()
```
