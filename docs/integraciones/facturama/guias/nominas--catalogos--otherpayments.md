<!-- fuente: https://apisandbox.facturama.mx/guias/nominas/catalogos/otherpayments · capturado 2026-09-03 -->

# Catálogo de Otros Pagos
...
**https://apisandbox.facturama.mx/catalogs/otherpayments**
...
```
payment_method = facturama.catalog.other_payments
```
...
```
$lstNameIds = $facturama->get('catalogs/OtherPayments');
```
...
```
Facturama.Catalogs.OtherPayments(function (result) {
...
```
List paymentForm = facturama.Catalogs().OtherPayments();
```
...
```
var paymentForm = facturama.Catalogs.OtherPayments;
```
...
self.client._credentials = ('username', 'password')
    lst_payment_methods = self.client.OtherPayments.query()
```
