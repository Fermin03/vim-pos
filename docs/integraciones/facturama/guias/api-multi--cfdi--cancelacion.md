<!-- fuente: https://apisandbox.facturama.mx/guias/api-multi/cfdi/cancelacion · capturado 2026-09-03 -->

# Cancelación de CFDI 4.0 con Motivo
...
- Cuando se requiera la aceptación para la cancelación el receptor tendrá hasta 24 horas para aceptar o rechazar la solicitud de cancelación (este proceso es en el SAT).
...
https://apisandbox.facturama.mx/api-lite/cfdis/{id}?motive={motive}&uuidReplacement={uuidReplacement}
    ...
    Ejemplo:
    https://apisandbox.facturama.mx/api-lite/cfdis/yrjnzL1DCU38KEHpEsJrtg2?motive=01&uuidReplacement=d8e34bab-5bd4-4788-bde2-1428dc469e10
```
...
#### Los datos del estado de la cancelación son:
	...
	**Message**:  Mensaje del proceso de cancelación
	...
	**CancelationDate**:  Fecha en que declara cancelado el CFDI (puede ser diferente a la fecha de solicitud, por que espera la respuesta del receptor)
