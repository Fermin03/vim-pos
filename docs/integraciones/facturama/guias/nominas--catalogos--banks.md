<!-- fuente: https://apisandbox.facturama.mx/guias/nominas/catalogos/banks · capturado 2026-09-03 -->
...
**https://apisandbox.facturama.mx/catalogs/banks**
...
```
$lstNameIds = $facturama->get('catalogs/banks');
```
...
```
Facturama.Catalogs.banks(function (result) {
...
```
List paymentForm = facturama.Catalogs().Banks();
```
...
```
var paymentForm = facturama.Catalogs.Banks;
```
...
self.client._credentials = ('username', 'password')
    lst_payment_methods = self.client.Banks.query()
```
