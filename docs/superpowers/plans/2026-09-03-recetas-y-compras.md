...
<cfdi:Comprobante xmlns:cfdi="http://www.sat.gob.mx/cfd/4" xmlns:tfd="http://www.sat.gob.mx/TimbreFiscalDigital"
  ...
  Moneda="${moneda}" Total="448.00" TipoDeComprobante="${tipo}" LugarExpedicion="37000">
  <cfdi:Emisor Rfc="PSM010101AB1" Nombre="PANIFICADORA SMOKE SA DE CV" RegimenFiscal="601"/>
  <cfdi:Receptor Rfc="XAXX010101000" Nombre="PUBLICO EN GENERAL" UsoCFDI="G01" DomicilioFiscalReceptor="37000" RegimenFiscalReceptor="612"/>
...
describe("leerCfdiRecibido", () => {
  it("lee cabecera, emisor, receptor, timbre y conceptos con descuento e IVA", () => {
    ...
    expect(r.cfdi.receptorRfc).toBe("XAXX010101000");
