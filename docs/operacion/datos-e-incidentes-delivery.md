...
certificado anual de cumplimiento (C13) si Uber lo pide. Dueño: el dueño. Revisar cada trimestre.
...
3. **Avisar a Uber dentro de las 24 horas** desde que se detecta, aunque no se sepa todo aún:
   ...
   > actualización: <fecha>. Contacto: VIM POS, integraciones@vimpos.com.mx, hola@vimpos.com.mx.
...
| Cuando Uber lo pida (máx. 1 vez al año) | Certificado de cumplimiento firmado por el dueño con este documento como respaldo |
